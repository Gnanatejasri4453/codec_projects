...
Original file is located at
    https://colab.research.google.com/drive/1g4_SuscsdF8OMArOroSFHQpmyQsgsvqd
...
import pandas as pd
df = pd.read_csv('/content/sample_data/Fake.csv (2).zip')
print(df.head())
...
"""**TD_IDF vectorization**"""

from sklearn.feature_extraction.text import TfidfVectorizer


X_train = ["This is a sample document.", "Another example document."]
X_test = ["Sample document for testing."]
vectorizer = TfidfVectorizer(stop_words='english', max_df=0.7)

X_train_tfidf = vectorizer.fit_transform(X_train)
X_test_tfidf = vectorizer.transform(X_test)

""" **Train a support vector MACHINE(SVM)MODEL PYTHON**"""
...
df = pd.read_csv(/content/Fake.csv (2).zip)
df['label'] = df['subject']
